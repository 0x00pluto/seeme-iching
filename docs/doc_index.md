...
### [faqs/how-to-fix-vercel-sse-connection-closed.md](./faqs/how-to-fix-vercel-sse-connection-closed.md)

**FAQ 版式**（Q/A：问题症状 / 根本原因 / 解决方案）：Vercel 同源 SSE 断连、`SSE_PERIODIC_PING_MS`、代码入口与自助排查。
