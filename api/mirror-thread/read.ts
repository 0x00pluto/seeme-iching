/**
 * Vercel Serverless：POST /api/mirror-thread/read
 */
import type { VercelRequest, VercelResponse } from "@vercel/node";
import { handleMirrorThreadRead } from "../../server/mirror-thread-handlers.js";
...
export default async function handler(req: VercelRequest, res: VercelResponse): Promise<void> {
  try {
    ...
    const result = await handleMirrorThreadRead(cookieHeader, req.body);
    ...
    console.error("api/mirror-thread/read:", e);
