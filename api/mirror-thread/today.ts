/**
 * Vercel Serverless：GET /api/mirror-thread/today
 */
import type { VercelRequest, VercelResponse } from "@vercel/node";
import { handleMirrorThreadToday } from "../../server/mirror-thread-handlers.js";
...
export default async function handler(req: VercelRequest, res: VercelResponse): Promise<void> {
  try {
    ...
    const result = await handleMirrorThreadToday(cookieHeader);
    ...
    console.error("api/mirror-thread/today:", e);
